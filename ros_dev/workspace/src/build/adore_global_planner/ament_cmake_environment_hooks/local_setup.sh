...
: ${AMENT_CURRENT_PREFIX:="/workspace/src/install/adore_global_planner"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/adore_global_planner/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/adore_global_planner/environment/path.sh"
